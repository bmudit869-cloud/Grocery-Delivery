      ...
      <div className="flex gap-4">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            {addr.isDefault && (<span className="flex-center gap-1 px-2.5 py-0.5 text-[10px] font-medium bg-app-cream text-white rounded-full"> <CheckIcon className="size-2.5"/> Default </span>)}
          </div>
