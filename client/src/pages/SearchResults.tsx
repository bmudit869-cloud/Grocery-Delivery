        ...
        {/* Breadcrumb */}
                ...
                {loading ? (<Loading/>) : products.length===0 ? (
                    <div className="text-center py-20">
                         <Search className="size-16 text-app-border mx-aut0 mb-4"/> 
                         <h2 className="text-xl font-semibold text-app-green mb-2"> No Results Found </h2>
                          <p className="text-sm text-app-text-light mb-6 max-w-md mx-auto"> We could not find any products matching "{query}". Try a different search term </p>
                          <Link to='/products' className="inline-flex px-5 py-2.5 bg-app-green text-white text-sm font-medium rounded-lg "> Browse All Products </Link> </div>) :
