...
const Addresses = () => {
    ...
    const onEditHandles = (add:Address) => {
  ...
  return (
    <div className="min-h-screen bg-app-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <h2 className="text-2xl font-semibold text-app-green"> My Addresses </h2>
            ...
            <PlusIcon className="size-4"/> Add Address </button>
             ...
             {loading ? (
                ...
                <p className="text-sm text-app-text-light"> Add an address for faster checkout </p>
                    ...
                    {addresses.map((addr)=> ( <AddressCard key={addr._id} addr={addr} onEditHandler={onEditHandles} setAddresses={setAddresses}/> ))}
                     </div>
                )}
        </div>
    </div>
