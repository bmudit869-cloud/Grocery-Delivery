...
const Checkout = () => {
    ...
    const[address , setAddress] = useState<Address>({_id: "", label: "Home", address: "", city: "", state: "", zip: "", isDefault: false, lat:0, lng:0})
    ...
    useEffect(()=> {
        if(user.addresses.length){
            ...
            setAddress({_id: defaultAddr._id,
    ...
    if(items.length===0)
    {
        return (
            ...
            <div className="text-center">
              ...
              className="px-5 py-2.5 bg-app-green text-white text-sm font-semibold rounded-xl hover:bg-app-green-light transition-colors"> Browse Products</button>
            </div>
            </div>
        )
    }
