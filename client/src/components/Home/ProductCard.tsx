      ...
      <div className="p-3 text-zinc-700">
        ...
        {product.rating > 0 && (
          <div className="flex items-center gap-1 mb-2">
            ...
            <Star className="w-3 h-3 text-app-warning fill-app-warning" />
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="w-7 h-7 rounded-full bg-app-orange text-white flex items-center justify-center shrink-0 hover:bg-app-orange-dark transition-colors active:scale-95"
          >
